...
if weather_all_steps and config['save']:
    plt.savefig(f'{cd}//plots//{freq}_{target_park}_NN_abs_RMSE_vs_horizon_weather.pdf')
elif (weather_all_steps == False) and config['save']:
    plt.savefig(f'{cd}//plots//{freq}_{target_park}_NN_abs_RMSE_vs_horizon.pdf')
plt.show()
...
if weather_all_steps and config['save']:
    plt.savefig(f'{cd}//plots//{freq}_{target_park}_{min_lag}_MNAR_weather.pdf')
elif (weather_all_steps == False) and config['save']:
    plt.savefig(f'{cd}//plots//{freq}_{target_park}_{min_lag}_MNAR.pdf')
plt.show()
